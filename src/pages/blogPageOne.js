        ...
        return(
            <article>
                <section className="blogPageOne">
                    ...
                    <p className="one-P">
            To answer this i would like to first point the compound expression
            that Mingnolo & Walsh introduce: The colonial matrix of power. They
            define this matrix as the convergence of modernity and coloniality.
            And considering the fact that this matrix of power is plural in
            nature they consider it important that readers, seek to define what
            decolonisation means to them. This is particularly interesting
            because by so doing they priortise geo-political relative truths,
            ...
            consider other ways and forms of cultivating knowledge, without
            necessary eliminating and blindly accepting western thought.
          </p>
          <p className="one-P">
            ...
            most of us. Therefore, for me considering my geo-political standing
            in modern day South Afrcia. I would like to discuss and explore
            decolonisation through the lens of cultural heritage in an effor to
            see myself clearly. Now since the dawn colonisation, separation,
            segregation acts defined the mobility of the formerly colonised. And
            ...
            homesteads has brought about elements of modernity into the South
            African lives. And considering that modernity is a way of living it
            means that it is a practice and custom.
          </p>
          <p className="one-P">
          ...
          <p className="one-P">
            ...
            the act of "seeing myself clearly" in relation to otherselves with
            ...
            becomes a very important concept/practice to consider, and as such
            ...
            practicing art as heritage through and on the internet.
          </p>
                </section>
            </article>
        )
